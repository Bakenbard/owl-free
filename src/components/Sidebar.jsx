     ...
     return (<div style={styles.Sidebar}>
                ...
                <div className="widget brands mb-50">
                    ...
                    <div className="widget-desc">
                        ...
                        // Single Form Check -->
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="furniture"></input>
                                <label className="form-check-label" htmlFor="furniture">Furniture Inc</label>
                        </div>
                        // Single Form Check -->
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="factory"></input>
                                <label className="form-check-label" htmlFor="factory">The factory</label>
                        </div>
                        // Single Form Check -->
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="" id="artdeco"></input>
